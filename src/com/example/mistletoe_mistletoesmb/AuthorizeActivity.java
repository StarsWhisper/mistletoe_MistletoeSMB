...
//        hintView.setMovementMethod(new ScrollingMovementMethod());
        ...
        mSsoHandler = new SsoHandler(AuthorizeActivity.this, mAuthInfo);
...
//            @Override
//            public void onClick(View v) {
//                startActivity(new Intent(AuthorizeActivity.this, WBAuthCodeActivity.class));
//            }
//        });
    ...
    class AuthListener implements WeiboAuthListener {
        ...
        public void onComplete(Bundle values) {
            ...
            if (mAccessToken.isSessionValid()) {
                ...
                AccessTokenKeeper.writeAccessToken(AuthorizeActivity.this, mAccessToken);
                ...
                Toast.makeText(AuthorizeActivity.this, message, Toast.LENGTH_LONG).show();
            }
        }
