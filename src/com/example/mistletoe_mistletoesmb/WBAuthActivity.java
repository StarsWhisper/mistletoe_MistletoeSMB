...
public class WBAuthActivity extends Activity {
  ...
  //槲寄生
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //槲寄生：进入主界面
        enterMainActivity = (Button)findViewById(R.id.enterMain);
        enterMainActivity.setOnClickListener(new OnClickListener() {	
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.setClass(WBAuthActivity.this, MistletoeSMBMainActivity.class);
